    ...
    <div class="page-about-lead__inner inner">
      <div class="page-about-lead__content-sp">
        <div class="page-about-lead__image">
          <figure class="page-about-lead__image-right js-fadeIn">
            <img src="<?php echo get_theme_file_uri() ?>/assets/images/common/about2.jpg" alt="ホテルの寝室の画像"
              loading="lazy">
          </figure>
          <h1 class="page-about-lead__body-title js-fadeIn">with all<br>one's heart</h1>
        </div>
        <div class="page-about-lead__box">
          <p class="page-about-lead__text js-fadeIn">
      ...
      <div class="page-about-lead__content-pc about-main-image">
        <div class="about-main-image__image">
          <figure class="about-main-image__image-left js-fadeIn">
            <img src="<?php echo get_theme_file_uri() ?>/assets/images/common/about2.jpg" alt="ホテルの寝室の画像"
              loading="lazy">
          </figure>
          <figure class="about-main-image__image-right js-fadeIn">
            <img src="<?php echo get_theme_file_uri() ?>/assets/images/common/about1.jpg" alt="ホテルのレストランの画像"
              loading="lazy">
          </figure>
        </div>
        <div class="about-main-image__body">
          <h1 class="about-main-image__body-title js-fadeIn">with&nbsp;all<br>one's&nbsp;heart</h1>
      ...
      <div class="page-about-gallery__container">
        ...
        <div class="page-about-gallery__image">
          ...
          <?php
                ...
                ?>
          <img class="js-parallax" src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($image_alt); ?>"
            loading="lazy">
          <?php endif; ?>
        </div>
        <?php
